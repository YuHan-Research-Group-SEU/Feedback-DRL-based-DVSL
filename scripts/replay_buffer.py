...
class ReplayBuffer:
    ...
    def calc_multistep_return(self, n_step_buffer):
        Return = 0
        state_look_ahead,done_look_ahead =n_step_buffer[0][3],n_step_buffer[0][4]
        for idx in range(self.n_step):
            Return += self.gamma**idx * n_step_buffer[idx][2]
            if n_step_buffer[idx][4]:
                state_look_ahead =n_step_buffer[idx][3]
                done_look_ahead = n_step_buffer[idx][4]
                break
            else:
                state_look_ahead =n_step_buffer[idx][3]
                done_look_ahead = n_step_buffer[idx][4]
        return n_step_buffer[0][0], n_step_buffer[0][1], Return, state_look_ahead , done_look_ahead
